<div class="guide-header">
    <div class="guide-header-title">
        ...
        <div>
            <h2>Panduan Tim Teknis Sustain</h2>
            <p>Anda memegang seluruh rantai teknis ISPO: tinjauan, keputusan Setujui/Tolak, penugasan auditor, Surat Tugas, penerbitan sertifikat, sampai surveillance.</p>
        </div>
    </div>
</div>
...
<div class="guide-section">
    ...
    <div class="step-cards-grid">
        <div class="step-card">
            ...
            <h4>Meninjau Permohonan ISPO</h4>
            <p>Buka permohonan yang diteruskan Tim Admin Sustain. Antrean Anda hanya memuat ISPO; skema lain ditangani Tim Teknis.</p>
        </div>
        <div class="step-card">
            <span class="step-badge">Langkah 2</span>
            <h4>Mengisi Tinjauan FrO.7204</h4>
            <p>Formulir tinjauan ISPO memakai kolom bercentang per ruang lingkup pemohon, berbeda dari formulir skema ISO maupun LSPro.</p>
        </div>
        <div class="step-card">
        ...
        <div class="step-card">
            ...
            <p>Keputusan akhir permohonan ISPO ada di tangan Anda. Menyetujui akan membuat PDF tinjauan dan meneruskan order ke Finance.</p>
        </div>
        <div class="step-card">
            <span class="step-badge">Langkah 5</span>
            <h4>Menerbitkan Surat Tugas</h4>
            <p>Setelah pembayaran lunas, buka menu Penugasan &amp; Surat Tugas. Surat ISPO memakai template 002; unggah tanda tangan berstempel lalu terbitkan per tahap audit.</p>
        </div>
        <div class="step-card">
            <span class="step-badge">Langkah 6</span>
            <h4>Menerbitkan Sertifikat</h4>
            <p>Setelah audit selesai tanpa temuan terbuka, siapkan draft, jalankan review, lalu terbitkan dokumen akhir sertifikat dan jadwal surveillance.</p>
        </div>
    </div>
</div>
...
<div class="guide-section">
    ...
    <div class="quick-actions-grid">
        <a href="{{ route('technical.reviews.index') }}" class="quick-action-btn">
            <strong>Buka Antrean Tinjauan ISPO</strong>
        ...
        <a href="{{ route('technical.index') }}" class="quick-action-btn">
            ...
            <span>Kelola pemeriksaan akhir dan penerbitan sertifikat ISPO</span>
        </a>
    </div>
</div>
...
<div class="guide-section">
    ...
    <div class="faq-accordion">
        <details class="faq-item">
            <summary>Mengapa saya hanya melihat permohonan ISPO?</summary>
            <p>Memang begitu pembagiannya. ISPO menjadi tanggung jawab tim Sustain, sedangkan skema ISO dan LSPro ditangani Tim Teknis. Membuka order skema lain lewat tautan langsung akan ditolak sistem.</p>
        </details>
        <details class="faq-item">
            <summary>Bagaimana bila saya juga memegang peran Tim Teknis?</summary>
            <p>Antrean Anda menjadi gabungan keduanya — ISPO dan skema lain tampil bersama, dan seluruhnya dapat dibuka.</p>
        </details>
        <details class="faq-item">
        ...
        <details class="faq-item">
            ...
            <p>Tidak. Unggahan tanda tangan berstempel hanya membubuhi Surat Tugas. PDF Tinjauan Permohonan tetap memakai tanda tangan elektronik dari profil akun Anda — pastikan sudah diunggah di halaman Profil.</p>
        </details>
        <details class="faq-item">
        ...
        <details class="faq-item">
            <summary>Siapa auditor yang bisa saya pilih?</summary>
            <p>Daftar auditor dipakai bersama seluruh skema. Yang membedakan hanya siapa yang menugaskan: untuk ISPO, Andalah penugasnya.</p>
        </details>
        <details class="faq-item">
