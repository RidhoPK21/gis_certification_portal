...
class ApplicationController extends Controller
{
    ...
    {
        $this->own($request, $application);
        $application->load(['scheme', 'values', 'documents.currentVersion', 'revisions', 'statusHistory', 'invoice.payments', 'auditStages', 'findings.correctiveActions', 'certificateDrafts', 'certificateFinal']);
